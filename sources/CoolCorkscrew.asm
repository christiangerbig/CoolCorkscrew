...
; PT 8xy command
; 800	Start intro
; 810	Increase variable x radius angle step
; 820	Start to calculate z planes step
...
hcs_init_xy_coordinates
	movem.l a4-a5,-(a7)
	move.l	#$0000ffff,d3		; mask low word
...
hcs_init_sprites_bitmaps
	...
	lea	spr_pointers_construction(pc),a3
...
scs_horiz_scrolltext_skip1
	...
	move.w	#(scs_horiz_scroll_window_y_size-(scs_text_char_y_size/2))*extra_pf2_plane_width*extra_pf2_depth,d3 ; reset y offset
...
horiz_char_scrolling
	...
	moveq	#0,d4			; to store X condition bit
	IFNE hcs_quick_x_max_restart_enabled
		move.w	#hcs_x_max,d5
	ENDC
	lea	spr_pointers_construction+(hcs_z_planes_number*QUADWORD_SIZE)(pc),a2 ; last sprite
	IFNE hcs_quick_x_max_restart_enabled
...
ms_copy_image_data
	...
	lea	spr_pointers_construction(pc),a5
...
image_fader_in_skip
	...
	move.w	d6,if_rgb8_colors_counter(a3) ; fader finished ?
	bne.s	image_fader_in_quit
...
sprite_fader_in_skip
	...
	bsr	if_rgb8_fader_loop
	move.w	d6,sprf_rgb8_colors_counter(a3) ; fader finished ?
	bne.s	sprite_fader_in_quit
